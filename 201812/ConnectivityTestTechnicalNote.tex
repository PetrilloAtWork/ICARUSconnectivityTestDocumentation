...
\usepackage[numbers]{natbib} % bibliography as Overleaf likes, with numerical citations
...
\title{
  ...
  {\small\emph{\href{https://sbn-docdb.fnal.gov/cgi-bin/sso/ShowDocument?docid=14316}{SBN DocDB 14316}}}
  }
...
\include{sections/operations}

\include{sections/software}

% \include{sections/softwaresetup}
