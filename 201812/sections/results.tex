...
\Cref{fig:TestPulseResponse} shows typical response of the channels to a test
...
(\micros{\approx 100}) and the time constant reflects the characteristics of the
full circuit including test capacitance, DBB capacitance and the circuit
capacitance. The amplitude in this test uses to be \milliV{200-300}
